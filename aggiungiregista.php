...
if(isset($_POST['conferma'])){
    ...
    {$query = "INSERT INTO Registi  (nome, cognome)
                VALUES ('$nome', '$cognome')";
        if ($result=$connex_db->query($query)){
            echo "<script> alert('Regista inserito correttamente!'); window.location.replace('/listaregisti.php')</script>";
        }
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form method="post">
                <div class="row g-3">
                    <div class="col-md-12">
                        <label for="artista" class="form-label">Nome</label>
                        <input type="text" class="form-control" id="artista" placeholder="Nome" name="artista">
                    </div>
                    <div class="col-md-12">
